...
- **[data-in-motion.md](data-in-motion.md)** — Data, stats, and infographic patterns. Reels-register (cyber-\*) and editorial-register (FT/Bloomberg) chart vocabulary.
- **[retention-ladder.md](retention-ladder.md)** — Hook → opener → reveal pacing rules for short-form retention. Read when authoring social or vertical videos.
- **[retention-overdrive.md](retention-overdrive.md)** — Hyper-cut hook patterns and Haiku scorer driver for high-velocity retention edits.
